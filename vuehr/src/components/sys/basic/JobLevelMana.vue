<template>
  <div>
    <div>
      ...
      <el-button icon="el-icon-plus" type="primary" size="mini" @click="addJobLevel">添加</el-button>
    </div>
    <div style="margin-top: 10px">
      <el-table
        ...
        <!--true和false的字段不能写成上边的字段模板-->
        <el-table-column label="是否启用">
          <template type="success" slot-scope="scope">
            <el-tag type="danger" v-if="scope.row.enabled">已启用</el-tag>
        ...
        <el-table-column width=180
          ...
          <template slot-scope="scope">
            <el-button size="mini" @click="updateEditView(scope.row)">编辑</el-button>
...
.length==0" @click="deleteMany">批量删除
      </el-button>
      <div>
        <el-dialog
            title="修改职称"
...
export default {
  ...
  methods: {
    ...
    /*对话框的确定属性*/
    doUpdate() {
      /*相当于发送更新请求,xxxRequest()中第二个参数表示请求的参数*/
