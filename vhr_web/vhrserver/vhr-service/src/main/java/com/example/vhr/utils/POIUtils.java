...
import com.example.vhr.service.PoliticsstatusService;
...
public class POIUtils {
    ...
    public static ResponseEntity<byte[]> employee2Excel(List<Employee> list) {
        ...
        //文档管理员
        docInfo.setManager("wdd");
        //获取文档摘要信息
        SummaryInformation summaryInfo = workbook.getSummaryInformation();
        //文档标题
        summaryInfo.setTitle("员工信息表");
        //文档作者
        summaryInfo.setAuthor("wdd");
        //创建样式
        //1.创建标题行的样式
                            ...
                            case STRING:
                                ...
                                switch (k) {
                                    ...
                                    case 13:
                                        ...
                                        break;
                                    case 14:
                                        int positionIdnex = allPositions.indexOf(new Position(cellValue));
                                        employee.setPosId(allPositions.get(positionIdnex).getId());
                                        break;
                                    case 15:
